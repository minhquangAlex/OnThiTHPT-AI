...
// Map icon
export const MathIcon = Calculator;
export const PhysicsIcon = Atom;
export const ChemistryIcon = FlaskConical;
export const BiologyIcon = Dna;
export const EnglishIcon = Languages;
