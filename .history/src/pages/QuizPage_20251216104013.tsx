...
import { Grid, X, ArrowLeft, ArrowRight, CheckCircle, AlertTriangle, BookOpen } from 'lucide-react'; // Thêm BookOpen
      ...
      <div className="max-w-3xl mx-auto">
        <Card className="min-h-[500px] flex flex-col relative shadow-xl border-0">
          ...
          <div className="p-6 sm:p-8 flex-1">
            ...
            {currentQuestion.groupContext && (
              <div className="mb-8 p-5 bg-blue-50 dark:bg-blue-900/10 border-l-4 border-blue-500 rounded-r-lg text-slate-800 dark:text-slate-200 shadow-sm">
                <div className="flex items-center gap-2 mb-3 border-b border-blue-200 dark:border-blue-800 pb-2">
                  <BookOpen className="w-5 h-5 text-blue-600"/>
                  <h4 className="text-sm font-bold text-blue-700 dark:text-blue-400 uppercase tracking-wide">
                    Dữ liệu / Bài đọc tham khảo
                  </h4>
                </div>
                <div className="whitespace-pre-wrap leading-relaxed text-justify font-serif text-base">
                  {currentQuestion.groupContext}
                </div>
              </div>
            )}
