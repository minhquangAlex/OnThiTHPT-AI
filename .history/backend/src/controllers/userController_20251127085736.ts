...
export const updateUser = async (req: Request, res: Response) => {
  try {
    ...
    // allow owner or admin to update profile fields
    ...
    res.json({ message: 'Cập nhật thành công', user: { _id: user._id, name: user.name, role: user.role, email: user.email, className: user.className, school: user.school } });
  } catch (err) {
