        ...
        <div className="p-6">
          {step === 'signup' ? (
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              {/* <--- 3. Cập nhật ô Mật khẩu với nút con mắt */}
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-4 pr-10 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    disabled={loading}
                  />
                  <button
                    type="button"
              ...
              {/* <--- 3. Cập nhật ô Xác nhận mật khẩu với nút con mắt */}
              <div>
